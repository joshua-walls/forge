...
//   5. Collect values, build a vault-patch.yaml
//   6. Write patch to System/Exports/vault-patch.yaml
...
class VaultRepairModal extends Modal {
  ...
  private renderFinish(): void {
    ...
    contentEl.createEl("p", {
      text: "The repair patch will be written to System/Exports/vault-patch.yaml.",
