...
| Inbox retention action | Either deletes stale inbox files during maintenance or leaves them for Vault Lint warnings |
...
If inbox retention is set to warning, maintenance leaves inbox notes untouched and Vault Lint reports them instead.
